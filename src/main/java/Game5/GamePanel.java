...
public class GamePanel extends JPanel implements Runnable, MouseListener, MouseMotionListener {
	...
	private Cannon concreteCannon = new Cannon();
	private SimulationBuilder angleSlider = new SimulationBuilder(50, 155, 157, 0, "Angle");
	private SimulationBuilder sizeSlider = new SimulationBuilder(50, 225, 0, 75, "Size");
	private SimulationBuilder powerSlider = new SimulationBuilder(50, 295, 150, 0, "Power");
	...
	private void gameRender() {
		...
		//Cannon
		g = concreteCannon.draw(g, angleSlider.getValue(), sizeSlider.getValue(), powerSlider.getValue());
