...
public class ShapeObjectPool implements ObjectCreation_IF {

    private Tetrominoes pieceShape;
    private int[][] coords;
    private ObjectCreation_IF c;

    private ShapeObjectPool(ObjectCreation_IF c) {this.c=c;}
    ...
    public ShapeObjectPool rotateLeft() {
        if(pieceShape == Tetrominoes.SquareShape) return this;
        ShapeObjectPool result = new ShapeObjectPool();
    ...
    public ShapeObjectPool rotateRight() {
