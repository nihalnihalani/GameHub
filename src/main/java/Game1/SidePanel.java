...
public class SidePanel extends JPanel {
    ...
    private final Font STATE_FONT = new Font("Arial", Font.BOLD, 15);
    private final Font BUTTON_FONT = new Font("Arial", Font.PLAIN, 19);
    ...
    private void generatePanel(){
    	...
    	ImageIcon img = new ImageIcon(getClass().getResource("/images/tetris2.png"));
