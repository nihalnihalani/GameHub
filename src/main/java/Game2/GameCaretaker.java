...
public class GameCaretaker implements MouseListener, ActionListener, WindowListener
{
    ...
    public GameCaretaker()
    {
        ...
        try 
        {
            p = new File(GameCaretaker.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getPath() + "/db.accdb";
//        	p =  "home/Documents/jessica/TetrisExample-master/bin/db.accdb";
        }
        catch (Exception ex) 
        {
    ...
    */
    ...
    {
        CellOriginator cells[][] = board.getCells();
    ...
    public void gameWon()
    {
        ...
        ArrayList<ScoreSnapshot.Time> bTimes = score.getBestTimes();
