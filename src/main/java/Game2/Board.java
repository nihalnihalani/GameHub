...
public class Board 
{
    ...
    public Board(int numberOfMines, int r, int c)
    {
        ...
        cells = new CellOriginator[rows][cols];
    ...
    public boolean checkSave()
    {
        ...
        try {
            String dbURL = GameCaretaker.dbPath;
  ...
  /*
    ...
    */
    ...
    public CellOriginator[][] getCells()
    {
        return cells;
    }
