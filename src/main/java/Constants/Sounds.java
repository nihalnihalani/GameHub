    ...
    private static synchronized void playSound(String toPlay) {
        try {
             ...
             */
        	        	 ...
        	        	 AudioInputStream inputStream = AudioSystem.getAudioInputStream(Sounds.class.getResourceAsStream(toPlay));

//        	 AudioInputStream inputStream = AudioSystem.getAudioInputStream(new File(toPlay));
...
//            AudioInputStream audio = AudioSystem.getAudioInputStream(Sounds.class.getResource(toPlay));
